...
export class RegistroComponent implements OnInit {
  ...
  public registrar() {
    ...
    this.registroVM = Object.assign({}, this.registroVM, this.form.value) // Objetos com atributos de mesmo nome/tipo podem ser assimilados via Object.assign
  ...
  private processarSucesso(registroRealizado: TokenViewModel) {
    this.localStorageService.salvarDadosDoUsuario(registroRealizado);
