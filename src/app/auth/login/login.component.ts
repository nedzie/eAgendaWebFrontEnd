...
import { AutenticarUsuarioViewModel } from '../view-models/autenticar-usuario.viewmodel';
...
export class LoginComponent implements OnInit {
  ...
  public login(): void {
    ...
    this.authService.login(this.loginVM)
      .subscribe({
  ...
  private processarSucesso(loginRealizado: TokenViewModel) {
    this.localStorage.salvarDadosDoUsuario(loginRealizado);
